...
- [Usage Guide](usage.md) — providers, models, configuration, provider profiles
- [Internal Agent](agent.md) — how the agent loop works: tools, context, streaming
- [Context Management](context-management.md) — three-tier history, token budget, design philosophy
